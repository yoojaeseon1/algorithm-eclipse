...
public class Test {
    ...
    public static void main(String[] args) throws IOException{
        ...
        System.out.println("black count : " + b_cnt);
        System.out.println("white count : " + w_cnt);
        System.out.println("white search count : " + searchCount);
    ...
    public static void white_search(boolean[][] visited, int y, int x, int cnt) {
    	searchCount++;
//    	System.out.println("into searchWhite");
